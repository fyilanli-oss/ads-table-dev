...
const files = Object.freeze([
  ...
  'tests/e2-t8-restore-readiness-artifacts.test.js', 'tests/e3-t1-critical-route-characterization.test.js'
]);
const groups = Object.freeze({
  auth: ['tests/oauth-security-baseline.test.js', 'tests/e3-t1-critical-route-characterization.test.js'], idor: ['tests/oauth-authorization-contract.test.js'],
