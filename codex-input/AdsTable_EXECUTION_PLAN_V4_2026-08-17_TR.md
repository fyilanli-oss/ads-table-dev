...
| R7 | Currency-first ve Shopify-native Connect/Disconnect UX | E10-T5 + E10-T6-C2I-V10 | `R7-A Ready; R7-B blocked by R6-D` — R7-A Currency→Data Sources→explanation modal→OAuth→verified account→conditional Klaviyo cost foundation'ını açar; R6-D gerçek provider kabulünden sonra R7-B Connected ve warning modal kullanan Disconnect deneyimini tamamlar. |
