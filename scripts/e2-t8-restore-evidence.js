...
const FINAL_GATE_KEYS = ['managed_primitives_ok','application_row_count_exact','allowlist_complete'];
...
function convert({ sourceInventory, targetPreflight, targetInventory, targetFinalGates, manifest, migrationClassification }) {
  ...
  else if (!targetFinalGates.managed_primitives_ok || targetFinalGates.application_row_count_exact !== 0 || !targetFinalGates.allowlist_complete) errors.push('TARGET_FINAL_GATES');
