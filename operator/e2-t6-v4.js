...
const { buildEvidence } = require('../scripts/e2-t6-v4-evidence');

const APPROVED_MAIN_SHA = '43fbed29e73713746084e6973e4cbc60e59e9826';
const OPERATION = 'e2_t6_rls_v4';
const VERSION = 'e2-t6-rls-v4';
const SQL = Object.freeze({
  preflight: 'docs/security/sql/E2_T6_RLS_V4_PREFLIGHT.sql',
  transaction: 'docs/security/sql/E2_T6_RLS_V4_TRANSACTION.sql',
  postcheck: 'docs/security/sql/E2_T6_RLS_V4_POSTCHECK.sql'
});
const ARTIFACTS = Object.freeze([
  ...Object.values(SQL),
  'operator/e2-t6-v4.js',
  'operator/management-api.js',
  'operator/state-store.js',
  'scripts/e2-t6-v4-operator.js',
  'scripts/e2-t6-v4-evidence.js',
  'artifacts/dataset-v2-acceptance/e2-t6-rls/fixture-contract-v4.json',
...
function terminalError(code) { const error = new Error('E2-T6 V4 stopped fail-closed'); error.safeCode = code; return error; }
...
async function execute({ repo, stateFile, client, confirmation, verifyRepository = verifyGit }) {
  if (confirmation !== 'E2-T6-V4-LIVE') throw new Error('Exact human confirmation is required');
