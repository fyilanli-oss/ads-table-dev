...
| R6 | Embedded provider runtime → canonical V2 | E4 + E5 + E7 | `In progress / R6-D2 Klaviyo live PASS; R6-D3 Meta full lifecycle live PASS; R6-D4-C Google Ads connection/account selection live PASS; R6-D4-D live PASS / R6-D4-E next` — Google Sheets ve GA4 parked kalır. Üç bağlı Google Ads hesabında tamamlanmış E5 Standard/PMax ve Time/FX motoru salt okunur çalıştırılmış; provider doğrulanmış boş sonuç vermiş, Supabase son kontrolü geçmiş ve Dataset V2 `0` kalmıştır. |
