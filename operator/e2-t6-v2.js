...
const { buildEvidence } = require('../scripts/e2-t6-v2-evidence');

const APPROVED_MAIN_SHA = 'fcbaa7cf1e6a849dd363f0eccb655977b583ff20';
const OPERATION = 'e2_t6_rls_v2';
const VERSION = 'e2-t6-rls-v2';
const SQL = Object.freeze({
  preflight: 'docs/security/sql/E2_T6_RLS_V2_PREFLIGHT.sql',
  transaction: 'docs/security/sql/E2_T6_RLS_V2_TRANSACTION.sql',
  postcheck: 'docs/security/sql/E2_T6_RLS_V2_POSTCHECK.sql'
});
const ARTIFACTS = Object.freeze([
  ...Object.values(SQL),
  'operator/e2-t6-v2.js',
  'operator/management-api.js',
  'operator/state-store.js',
  'scripts/e2-t6-v2-operator.js',
  'scripts/e2-t6-v2-evidence.js',
  'artifacts/dataset-v2-acceptance/e2-t6-rls/fixture-contract.json',
...
function terminalError(code) { const error = new Error('E2-T6 V2 stopped fail-closed'); error.safeCode = code; return error; }
...
async function execute({ repo, stateFile, client, confirmation, verifyRepository = verifyGit }) {
  if (confirmation !== 'E2-T6-V2-LIVE') throw new Error('Exact human confirmation is required');
