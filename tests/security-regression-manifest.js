...
const files = Object.freeze([
  ...
  'tests/e2-t5-rejection-artifacts.test.js', 'tests/e2-t5-operator.test.js', 'tests/e2-t6-rls-artifacts.test.js', 'tests/e2-t6-operator.test.js', 'tests/e2-t7-cleanup-artifacts.test.js',
...
const groups = Object.freeze({
  ...
  redaction: ['tests/production-config.test.js', 'tests/provider-token-backfill.test.js', 'tests/e2-t5-operator.test.js', 'tests/e2-t6-operator.test.js']
});
