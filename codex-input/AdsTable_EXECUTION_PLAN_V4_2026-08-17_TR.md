...
| R7 | Currency-first ve Shopify-native Connect/Disconnect UX | E10-T5 + E10-T6-C2I-V10 | `R7-A1 repository complete; R7-A2 next; R7-B blocked by R6-D` — R7-A1 currency gate, explanation modal, aktif/parked provider sınırı ve canonical OAuth pending write'ı tamamlar. R7-A2 Meta/Google verified account selection ve üç provider repository kabulünü tamamlar. R6-D gerçek provider kabulünden sonra R7-B Connected ve warning modal kullanan Disconnect deneyimini açar. |
