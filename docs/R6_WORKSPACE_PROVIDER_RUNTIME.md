...
### R6-D3-F Meta bağımsız Disconnect — production Disconnect and clean Reconnect PASS
...
### R6-D4-E Google Ads kontrollü Dataset V2 kabulü — production verified-empty PASS
