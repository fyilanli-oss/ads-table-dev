...
const { buildEvidence } = require('../scripts/e2-t6-rls-evidence');

const APPROVED_MAIN_SHA = '5a9a450a3615a9edeb8101164fc91abe074708be';
const OPERATION = 'e2_t6_rls_v1';
const VERSION = 'e2-t6-rls-v1';
const SQL = Object.freeze({
  preflight: 'docs/security/sql/E2_T6_RLS_PREFLIGHT.sql',
  transaction: 'docs/security/sql/E2_T6_RLS_TRANSACTION.sql',
  postcheck: 'docs/security/sql/E2_T6_RLS_POSTCHECK.sql'
});
const ARTIFACTS = Object.freeze([
  ...Object.values(SQL),
  'operator/e2-t6-v1.js',
  'operator/management-api.js',
  'operator/state-store.js',
  'scripts/e2-t6-operator.js',
  'scripts/e2-t6-rls-evidence.js',
...
async function execute({ repo, stateFile, client, confirmation, verifyRepository = verifyGit }) {
  if (confirmation !== 'E2-T6-V1-LIVE') throw new Error('Exact human confirmation is required');
