...
const files = Object.freeze([
  ...
  'tests/e2-t8-restore-readiness-artifacts.test.js', 'tests/e3-t1-critical-route-characterization.test.js', 'tests/e3-t2-composition-root.test.js', 'tests/e3-t3-runtime-config.test.js', 'tests/e3-t4-shared-clients.test.js', 'tests/vercel-static-entrypoints.test.js'
]);
const groups = Object.freeze({
  auth: ['tests/oauth-security-baseline.test.js', 'tests/e3-t1-critical-route-characterization.test.js', 'tests/e3-t2-composition-root.test.js', 'tests/vercel-static-entrypoints.test.js'], idor: ['tests/oauth-authorization-contract.test.js'],
