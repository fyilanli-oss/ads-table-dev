...
test('Meta live acceptance requests 30 daily days and stores redacted evidence on the refresh job',()=>{assert.match(server,/until:snapshotDate,dayCount:30/);assert.match(server,/meta_v2_evidence:result\.meta_v2_evidence\|\|null/);});
