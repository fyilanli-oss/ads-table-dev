...
**Durum:** `In progress — E10-T5 product freeze Done (C1–C7; C5-B Deferred); E10-T6-A Done/PASS; E10-T6-B managed-installation runtime ve remote Supabase migration PASS; Shopify env 4/4 görünür, smoke encryption keyring process injection bekliyor; every production contact gated`
