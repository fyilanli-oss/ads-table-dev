...
function buildEvidence(result) {
  ...
  assert(result.operation_code === 'e2_t6_rls_v3', 'operation mismatch');
  ...
  return Object.freeze({ evidence_version:'e2-t6-rls-v3', operation_code:'e2_t6_rls_v3', status:'PASS', expected_case_count:16, passed_case_count:16, failed_case_count:0, unexpected_allow_count:0, residue_count:0, connected_unchanged:true, encrypted_unchanged:true, missing_encrypted_unchanged:true, orphan_encrypted_unchanged:true, plaintext_unchanged:true, rollback_required:true });
}
