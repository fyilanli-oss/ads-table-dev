...
function normalizeAccountStatus(status){const value=String(status||"").toLowerCase();if(!value)return"";return["trial","active","expired","suspended","deleted"].includes(value)?value:"expired"}
