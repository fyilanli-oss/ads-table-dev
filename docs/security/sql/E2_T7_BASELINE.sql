...
with policy_state as (
  ...
  union all select 'CONNECTED_CONNECTIONS',(select count(*) from public.platform_connections where connected=true),(select count(*) from public.platform_connections where connected=true),'capture'
  union all select 'ENCRYPTED_TOKEN_ROWS',(select count(*) from public.platform_connection_tokens),(select count(*) from public.platform_connection_tokens),'capture'
